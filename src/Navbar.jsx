    ...
    <div className="collapse navbar-collapse" id="navbarSupportedContent">
      ...
      <ul className="navbar-nav mb-2 mb-lg-0">
        ...
        {props.userData? <li className="nav-item">
            <span onClick={props.logOut} className="logOut nav-link order-lg-last order-first" >Logout</span>
          </li>
          :<>
              <li className="nav-item">
                <Link className="nav-link order-lg-last order-first" aria-current="page" to="login">Login</Link>
              </li>
              <li className="nav-item">
